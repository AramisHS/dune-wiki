  ...
  head: () => ({
    meta: [
      ...
      { title: "Arrakis · Wiki visual de DUNE" },
      {
        name: "description",
        content:
          "Una wiki visual e inmersiva del universo DUNE: personajes, grandes casas, planetas, criaturas y la especia melange.",
      },
      { property: "og:title", content: "Arrakis · Wiki visual de DUNE" },
      {
        property: "og:description",
        content: "Explora el universo de Frank Herbert: Atreides, Harkonnen, Fremen y los gusanos de Shai-Hulud.",
      },

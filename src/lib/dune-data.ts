...
export const chakobsa: Record<string, ChakobsaEntry> = {
  ...
  kalidh: { meaning: "Reverenda Madre", verified: true },
  ...
  bellaha: { meaning: "Sostener (plural)", verified: true },
  dimbi: { meaning: "Cuchillo (el/uno)", verified: true },
  isnii: { meaning: "De mí (movimiento de alejamiento)", verified: true },
};
...
export const chakobsaPhrases = [
  ...
  { phrase: "Itthuz Vessha", meaning: "Bendito sea el Hacedor." },
  { phrase: "Sa fadla", meaning: "Hola, saludos en paz." },
...
// ===================== FRASES COMPLETAS (CORPUS) =====================

export type FullPhrase = {
  chakobsa: string;
  spanish: string;
  // Opcional: desglose para depuración
  gloss?: string;
};
...
export const chakobsaFullPhrases: FullPhrase[] = [
  ...
  // Agrega más frases según vayas encontrando
];